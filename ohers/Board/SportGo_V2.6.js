...
let All=`<div class="containerMatch"><a href="${document.querySelector('input.Link').value}" title="${document.querySelector('input.asm2').value}vs${document.querySelector('input.asm1').value}">
    ...
    <div class="fareq">
    <div class="Imagee">
    <img alt="${document.querySelector('input.asm1').value}" class="col-img lazy" height="60" src="" data-src="${document.querySelector('input.fareq1').value}" title="${document.querySelector('input.asm1').value}" width="50" />
    </div>
    ...
    <div class="fareq">
        <div class="Imagee">
        <img alt="${document.querySelector('input.asm2').value}" class="col-img lazy" height="60" src="" data-src="${document.querySelector('input.fareq2').value}" title="${document.querySelector('input.asm2').value}" width="50" />
        </div>
